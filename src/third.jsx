...
function ThirdPage() {
  const gifEmbedCode = `
    <iframe src="https://giphy.com/embed/Gyc0RyjpLuMU9FQLs1" width="600" height="400" style="width:40%; height:auto;" frameborder="0" class="giphy-embed" allowfullscreen></iframe>
  `;
  ...
  return (
    <div style={{ backgroundColor: '#FFB6C1', height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', margin: 0, padding: 0 }}>
      ...
      <p style={{ textAlign: 'center', marginTop: '20px' }}>Bahut Shaitan ho</p>
